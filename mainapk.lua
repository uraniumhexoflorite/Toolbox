...
local button = widget.newButton(
	{
		left = 20,
		top = 20,
		defaultFile="Icon-Small.png",
		overFile="Icon-Small@2x.png",
		id = "button",
		label = "Default",
...
textboxspace = 0
texta = display.newText( "textBoxa", 200, 25, native.systemFont, 16 )
textb = display.newText( "textBoxb", 200, 150, native.systemFont, 16 )
textc = display.newText( "textBoxc", 200, 50, native.systemFont, 16 )
...
textBoxa = native.newTextField( 200, 100, 100, 50, vara )
textBoxa.inputType = "default"
textBoxa:addEventListener( "userInput", textListener )
textBoxb = native.newTextField( 200, 200, 100, 50, vara )
